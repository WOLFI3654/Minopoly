			...
			if (e.getCurrentItem() != null) {
				...
				if (FieldCommand.buyItem.isSimilar(e.getCurrentItem())) {
					InventoryConfirmation confirm = new InventoryConfirmation(
							"Mˆchtest du wirkich die Straﬂe " + e.getInventory().getTitle() + " kaufen?");
					...
					InventorySelector sel = this.createPlayerSelector(game, "Wer soll die Straﬂe bekommen?");
					sel.setCallback((i)->{
						...
						InventoryConfirmation confirm = new InventoryConfirmation(p.getDisplay()+ " mˆchte dir seine Straﬂe "+f.toString()+" ¸berlassen o/");
