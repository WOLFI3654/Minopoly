...
public class Minopoly extends GameObject implements CommandSender {
    ...
    public @Nullable
    Player getByFigureType(FigureType f) {
    ...
    public @Nullable
    SerializeablePlayer getBySPFigureType(FigureType f) {
        return this.savedPlayers.get(f);
    }

    public @Nullable
    Player getByBukkitPlayer(org.bukkit.entity.Player player) {
        for (final Player p : this.playingPlayers)
    ...
    public @Nullable
    Player getByPlayerName(String player) {
        for (final Player p : this.playingPlayers)
